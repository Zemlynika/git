...
В учебных целях у нас есть репозиторий этой статьи на GitHub и мы хотим исправить опечатку, которую нашли в статье, несмотря на то, что она уже исправлена.
